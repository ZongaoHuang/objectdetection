...
if __name__=='__main__':
    # 参考来自：https://github.com/hpc203
    parser = argparse.ArgumentParser()
    parser.add_argument('--imgpath', type=str, default='models/person.jpg', help="image path")
    parser.add_argument('--modelpath', type=str, default='models/picodet_s_416_coco.onnx', choices=["models/picodet_m_320_coco.onnx", "models/picodet_m_416_coco.onnx", "models/picodet_s_320_coco.onnx", "models/picodet_s_416_coco.onnx"], help="onnx filepath")
    parser.add_argument('--classfile', type=str, default='models/models.names', help="classname filepath")
